...
public class TokenProvider {
    ...
    private static final String SALT_KEY = "JpxM4e858rc673syopdZnMFb*ExeqJtUc0HJ_iOxu~jiSYu+yPdPw93OBBjF3syopdZnMF";
    ...
    /**
     * Creates the JWT token from {@link UserDetails} object.
     * @param t
     * @return
     */
    public String createToken(UserDetails t) {
        log.debug("createToken(UserDetails)");
        String authorities = t.getAuthorities().stream()
    ...
    public Authentication getAuthentication(String token) {
        log.debug("Entering getAuthentication(token)");
